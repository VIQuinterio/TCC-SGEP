    ...
    <main class="pt-32">
        <div class="container mx-auto">
            <div class="max-w-screen-lg mx-auto">
                ...
                <h5 class="text-gray">{{$unid_data->ds_endereco}}</h5>
                <h5 class="text-gray">{{$unid_data->ds_contato}}</h5>
                <div class="grid-unid pt-5">
                    <div class="mod-horario">
                    @foreach ($modalidades as $lista)
                        <p class="ml-1 text-gray text-sm news-text">{{$lista->nm_modalidade}}</p><br>
                        <p class="ml-1 text-gray text-sm news-text">{{$lista->ds_horario}}</p><br>
                    @endforeach
                    </div>
                    <div class="unid-mapa">
