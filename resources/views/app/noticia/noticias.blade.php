        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <tr style="background-color: #0B3142; color:aliceblue;">
                    ...
                    <th scope="col" class="px-6 py-3">
                        Autor
                        <a href="{{ route('app.noticia.index', ['sort' => 'autor', 'direction' => 'asc']) }}" class="sort-link">
                            <span class="sort-arrow sorts asc" data-sort="autor" data-direction="asc">&#8593;</span>
                        </a>
                        <a href="{{ route('app.noticia.index', ['sort' => 'autor', 'direction' => 'desc']) }}" class="sort-link">
                            <span class="sort-arrow sorts desc" data-sort="autor" data-direction="desc">&#8595;</span>
                        </a>                                                
                    </th>                     
                    <th scope="col" class="px-6 py-3">
                        Conteúdo
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="abrir-modal">
                        ...
                        <span class="sr-only">Cadastrar Notícia</span>
                    </button>
                </div>
                <!-- Modal body -->
