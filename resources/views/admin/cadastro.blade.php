...
<body>
    ...
    <div class="flex">
        <div
            class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 sidebar-container">
    ...
    <div class="flex-1 ml-64 p-9"> <!-- Adjust the ml-64 to create space between sidebar and table -->
        <div class="relative overflow-x-auto form-container">
            ...
            <form action="{{ route('admin.cadastro') }}" method="POST">
                @csrf
                <div class="mb-6">
