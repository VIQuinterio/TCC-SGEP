<div class="navbar">
    <footer class="py-12 mt-10 xl:pt-24">
                ...
                <ul
                    ...
                    <li>
                        <a href="{{ route('app.noticia.index') }}"
                            class="hover:underline me-4 md:me-6 mr-2">Notícias</a>
                    </li>
                    <li>
                        <a href="{{ route('app.modalidade.index') }}"
                            class="hover:underline me-4 md:me-6 mr-2">Modalidades</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('app.unidade.index') }}"
                            class="hover:underline me-4 md:me-6">Unidades</a>
                    </li>
                </ul>
            </div>
            <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <span class="block text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a
                    href="{{ route('app.home') }}" class="hover:underline">{{ $user_data->nm_usuario }}</a>.Todos
                os direitos reservados.</span>
            <span class="block text-sm text-white sm:text-center dark:text-gray-400">Desenvolvido por <a
                    href="{{ route('home') }}" class="hover:underline">Fatecanos</a></span>
        </div>
    </footer>
</div>